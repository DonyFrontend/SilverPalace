  ...
  return (
    <>
      <div className="flex flex-col gap-y-16 items-center text-white">
            ...
            <div className="flex flex-col gap-y-16">
              ...
              <div className="flex flex-col gap-y-7">
                ...
                <p className="text-[20px] w-2/3">
                  Гайды, персонажи, лор и последние новости по игре Silver
                  Palace. Мы собираем всё в одном месте.
                </p>
              </div>
            </div>
        ...
        <div className="w-[90%] flex flex-col items-center gap-y-20 justify-center">
          <News limit={3} />
          <Button to="/news">Узнать больше</Button>
        </div>
        <div className="w-[90%] flex flex-col items-center gap-y-20 justify-center">
          <Characters limit={3} />
          <Button to="/characters">Узнать больше</Button>
        </div>
      </div>
      <Footer />
    </>
